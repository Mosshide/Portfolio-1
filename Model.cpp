...
{
	_rotation = glm::rotate(anglex, glm::vec3(1, 0, 0));
	_rotation = glm::rotate(_rotation, angley, glm::vec3(0, 1, 0));
	_rotation = glm::rotate(_rotation, anglez, glm::vec3(0, 0, 1));
	//_transformation = _translation * _scalar * _rotation;
}
